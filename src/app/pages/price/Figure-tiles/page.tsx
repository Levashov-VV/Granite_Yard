            ...
            <div className="standartTiles-block">
                ...
                <div className="description">
                    <p className="description-text">
                        Фигурные памятники представляют собой уникальные и художественно
                        оформленные надгробия, которые отличаются от традиционных
                        прямоугольных стел своей сложной формой и выразительным дизайном.
                        Они могут принимать различные формы, включая сердца, ангелов,
                        деревья и другие символические изображения, что позволяет
