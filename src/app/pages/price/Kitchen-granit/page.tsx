            ...
            <div className="standartTiles-block">
                ...
                <div className="description">
                    <p className="description-text">
                        Гранит является одним из наиболее популярных материалов для кухонных
                        столешниц благодаря своим уникальным свойствам и преимуществам.
                        Помимо столешниц, гранит также используется для фартуков на кухне —
                        они дополняют столешницу и создают единый стиль пространства. Кроме
                        того, он применяется для подоконников из-за своей прочности при
                        постоянном нагреве от батарей. В целом использование гранита на
                        кухне обеспечивает сочетание практичности с эстетической
                        привлекательностью интерьера.                
                    </p>
