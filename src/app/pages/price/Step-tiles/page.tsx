            ...
            <div className="standartTiles-block">
                ...
                <div className="description">
                    <p className="description-text">
                        Пошаговые гранитные плиты — это элементы мощения, используемые для
                        создания садовых дорожек. Они располагаются с широкими зазорами
                        между собой, что позволяет траве расти или заполнять пространство
                        декоративными материалами, такими как каменная крошка или мульча.
                        Расстояние между плитами обычно соответствует среднему человеческому
                        шагу, что делает их удобными для ходьбы.           
                    </p>
